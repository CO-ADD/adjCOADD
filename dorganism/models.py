...
#-------------------------------------------------------------------------------------------------
    ...
    qc_record = models.CharField(max_length=150, null=True, blank=True, verbose_name = "QC Records")
    supplier = models.CharField(max_length=250, null=True, blank=True, verbose_name = "Supplier")
    ...
    def get_values(self):
        value_list=[]
        for field in self._meta.fields:
            if field.verbose_name in ["vitek_card","orgbatch_id","organism_id","batch_no","batch_notes","qc_status","qc_record","supplier","supplier_code","supplier_po","stock_date","stock_level","biologist"]:    
                value_list.append(field.value_to_string(self))
        return value_list
