# Generated by Django 4.1.3 on 2023-03-20 09:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lab_restriction', models.ForeignKey(blank=True, db_column='lab_restriction', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_MTA+', to='apputil.dictionary', verbose_name='Lab')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch_id', models.CharField(max_length=5, verbose_name='Batch ID')),
                ...
                ('supplier', models.CharField(blank=True, max_length=250, verbose_name='Supplier')),
                ('supplier_code', models.CharField(blank=True, max_length=120, verbose_name='Supplier Code')),
                ('supplier_po', models.CharField(blank=True, max_length=120, verbose_name='Supplier PO')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adeleted', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_adeleted_by', to=settings.AUTH_USER_MODEL, verbose_name='Deleted by')),
                ('aupdated', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_aupdated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by')),
                ('division', models.ForeignKey(db_column='division', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='Division', to='apputil.dictionary', verbose_name='Division')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stock_id', models.CharField(blank=True, max_length=15, verbose_name='Stock ID')),
                ...
                ('stock_type', models.ForeignKey(db_column='stock_type', on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_stock_type+', to='apputil.dictionary', verbose_name='Stock Type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aupdated_at', models.DateTimeField(editable=False, null=True, verbose_name='Updated at')),
                ('adeleted_at', models.DateTimeField(editable=False, null=True, verbose_name='Deleted at')),
                ('culture_type', models.CharField(blank=True, max_length=120, verbose_name='Culture Type')),
                ('media_use', models.CharField(blank=True, max_length=120, verbose_name='Media Use')),
                ...
                ('notes', models.CharField(blank=True, max_length=512, verbose_name='Media')),
                ('acreated', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_acreated_by', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('adeleted', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_adeleted_by', to=settings.AUTH_USER_MODEL, verbose_name='Deleted by')),
                ('aupdated', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_aupdated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by')),
                ('biologist', models.ForeignKey(db_column='biologist', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_Biologist', to=settings.AUTH_USER_MODEL, verbose_name='Biologist')),
