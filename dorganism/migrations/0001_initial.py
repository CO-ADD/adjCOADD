    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_id', models.CharField(blank=True, max_length=30, verbose_name='Pub ID')),
                ...
                ('seq_name', models.CharField(blank=True, max_length=120, verbose_name='Seq Name')),
                ...
                ('oxygen_pref', models.ForeignKey(blank=True, db_column='oxygen_pref', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_oxygen', to='apputil.dictionary', verbose_name='Oxygen')),
                ('pathogen_group', models.ForeignKey(blank=True, db_column='pathogen_group', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_pathogen', to='apputil.dictionary', verbose_name='Pathogen')),
                ('risk_group', models.ForeignKey(blank=True, db_column='risk_group', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_risk', to='apputil.dictionary', verbose_name='Risk Group')),
            ],
            options={
                'db_table': 'organism',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stock_date', models.DateField(blank=True, null=True, verbose_name='Stock Date')),
                ('stock_note', models.CharField(blank=True, max_length=80, verbose_name='Stock Note')),
