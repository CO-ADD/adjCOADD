    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('strain_ids', models.CharField(blank=True, max_length=200, null=True, verbose_name='Strain IDs')),
                ...
                ('res_property', models.CharField(blank=True, max_length=350, null=True, verbose_name='Resistance Property')),
                ('gen_property', models.CharField(blank=True, max_length=350, null=True, verbose_name='Genetic Property')),
                ('strain_origin', models.CharField(blank=True, max_length=350, null=True, verbose_name='Origin of Strain')),
                ('reference', models.CharField(blank=True, max_length=150, null=True, verbose_name='Reference')),
                ('growth_preference', models.CharField(blank=True, max_length=250, null=True, verbose_name='Growth/Screen Preference')),
                ...
                ('strain_identification', models.CharField(blank=True, max_length=150, null=True, verbose_name='Strain Identification')),
                ('mta_document', models.CharField(blank=True, max_length=150, null=True, verbose_name='MTA Document')),
                ('acreated', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='organism_acreated_by', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('adeleted', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='organism_adeleted_by', to=settings.AUTH_USER_MODEL, verbose_name='Deleted by')),
                ('aupdated', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='organism_aupdated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by')),
                ('biologist', models.ForeignKey(db_column='biologist', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='Biologist', to=settings.AUTH_USER_MODEL, verbose_name='Biologist')),
                ('lab_restriction', models.ForeignKey(blank=True, db_column='lab_restriction', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='apputil.dictionary', verbose_name='Lab')),
                ('mta_status', models.ForeignKey(blank=True, db_column='mta_status', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='MTA+', to='apputil.dictionary', verbose_name='MTA Status')),
            ],
            options={
                'db_table': 'organism',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acreated', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='organism_batch_acreated_by', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('adeleted', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='organism_batch_adeleted_by', to=settings.AUTH_USER_MODEL, verbose_name='Deleted by')),
                ('aupdated', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='organism_batch_aupdated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acreated', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='taxonomy_acreated_by', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('adeleted', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='taxonomy_adeleted_by', to=settings.AUTH_USER_MODEL, verbose_name='Deleted by')),
                ('aupdated', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='taxonomy_aupdated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acreated', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='orgbatch_stock_acreated_by', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('adeleted', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='orgbatch_stock_adeleted_by', to=settings.AUTH_USER_MODEL, verbose_name='Deleted by')),
                ('aupdated', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='orgbatch_stock_aupdated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by')),
                ('biologist', models.ForeignKey(db_column='biologist', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL, verbose_name='Biologist')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acreated', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='organism_culture_acreated_by', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('adeleted', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='organism_culture_adeleted_by', to=settings.AUTH_USER_MODEL, verbose_name='Deleted by')),
                ('aupdated', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='organism_culture_aupdated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by')),
                ('biologist', models.ForeignKey(db_column='biologist', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL, verbose_name='Biologist')),
                ('organism_id', models.ForeignKey(db_column='organism_id', on_delete=django.db.models.deletion.DO_NOTHING, to='dorganism.organism', verbose_name='Organism ID')),
            ],
            options={
