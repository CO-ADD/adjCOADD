    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doc_id', models.CharField(max_length=15, primary_key=True, serialize=False, verbose_name='Doc ID')),
                ('doc_name', models.CharField(max_length=120, verbose_name='Name')),
                ...
                ('doc_desc', models.CharField(blank=True, default='description', max_length=140, verbose_name='Description')),
                ('doc_source', models.CharField(blank=True, default='source', max_length=50, verbose_name='Source')),
            ...
            options={
                ...
                'ordering': ['doc_name'],
                'indexes': [models.Index(fields=['doc_name'], name='doc_name_idx'), models.Index(fields=['doc_source'], name='doc_scr_idx')],
            },
        ),
        migrations.CreateModel(
            name='Dictionary',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['log_code'], name='log_code_idx'), models.Index(fields=['log_proc'], name='log_proc_idx'), models.Index(fields=['log_type'], name='log_type_idx'), models.Index(fields=['log_status'], name='log_status_idx'), models.Index(fields=['log_object'], name='log_object_idx')],
            },
        ),
    ]
