    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drug_othernames', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=60), blank=True, null=True, size=30, verbose_name='Other Names')),
                ('drug_codes', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=10), blank=True, null=True, size=30, verbose_name='Drug Codes')),
                ('drug_note', models.CharField(blank=True, max_length=50, verbose_name='Drug Note')),
                ...
                ('drug_subclass', models.CharField(blank=True, max_length=100, verbose_name='SubClass')),
                ...
                ('uq_imb', models.CharField(blank=True, max_length=50, verbose_name='IMB')),
                ...
                ('structure_ids', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=15), blank=True, null=True, size=6, verbose_name='Structure IDs')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aupdated_at', models.DateTimeField(editable=False, null=True, verbose_name='Updated at')),
                ('adeleted_at', models.DateTimeField(editable=False, null=True, verbose_name='Deleted at')),
                ('org_name', models.CharField(blank=True, max_length=50, verbose_name='Organism')),
                ('notorg_name', models.CharField(blank=True, max_length=50, verbose_name='Not(Organism)')),
                ('med_application', models.CharField(blank=True, max_length=50, verbose_name='Application')),
                ('bp_type', models.CharField(blank=True, max_length=10, verbose_name='Type')),
                ('bp_mic_res_gt', models.DecimalField(blank=True, decimal_places=3, max_digits=9, null=True, verbose_name='MIC >Res')),
                ('bp_mic_sens_le', models.DecimalField(blank=True, decimal_places=3, max_digits=9, null=True, verbose_name='MIC <=Sens')),
                ('bp_zone_conc', models.CharField(blank=True, max_length=15, null=True, verbose_name='Zone Conc')),
                ('bp_zone_res_gt', models.DecimalField(blank=True, decimal_places=3, max_digits=9, null=True, verbose_name='Zone >Res')),
                ('bp_zone_sens_le', models.DecimalField(blank=True, decimal_places=3, max_digits=9, null=True, verbose_name='Zone <=Sens')),
                ('bp_comb', models.CharField(blank=True, max_length=20, verbose_name='Combination')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additive', models.CharField(blank=True, max_length=80, verbose_name='Additive')),
                ('acreated', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_acreated_by', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('adeleted', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_adeleted_by', to=settings.AUTH_USER_MODEL, verbose_name='Deleted by')),
                ('aupdated', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_aupdated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by')),
                ('drug_id', models.ForeignKey(db_column='drug_id', on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_drug_id', to='ddrug.drug', verbose_name='Drug ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organism', models.CharField(blank=True, max_length=120, verbose_name='Selected Organism')),
        ...
        migrations.AddIndex(
            model_name='drug',
            index=models.Index(fields=['structure_ids'], name='drug_csid_idx'),
        ),
        migrations.AddIndex(
            model_name='drug',
            index=models.Index(fields=['uq_imb'], name='drug_uq_idx'),
        ),
        migrations.AddIndex(
