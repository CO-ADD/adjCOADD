    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('screen_type', models.ForeignKey(blank=True, db_column='screen_type', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_ScreenType+', to='apputil.dictionary', verbose_name='Screen Type')),
            ],
            options={
                'db_table': 'screen_run',
