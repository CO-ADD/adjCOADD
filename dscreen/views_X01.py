...
from dscreen.forms import (ScreenRun_Filter, ScreenRun_Form,
...
def ScreenRun_DetailView(req, pk):
    context={}
    _object=get_object_or_404(Screen_Run, pk=pk)

    form=ScreenRun_Form(instance=_object,)
