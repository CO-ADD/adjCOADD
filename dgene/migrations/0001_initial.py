# Generated by Django 4.2.2 on 2023-09-22 01:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gene_name', models.CharField(blank=True, max_length=150, verbose_name='Gene Name')),
                ...
                ('amr_subclass', models.CharField(blank=True, max_length=50, verbose_name='AMR Subclass')),
                ...
                ('adeleted', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_adeleted_by', to=settings.AUTH_USER_MODEL, verbose_name='Deleted by')),
                ('aupdated', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_aupdated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by')),
                ('gene_type', models.ForeignKey(db_column='gene_type', on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_genetype', to='dgene.genome_sequence', verbose_name='Gene Type')),
            ],
            options={
                'db_table': 'gene',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aupdated_at', models.DateTimeField(editable=False, null=True, verbose_name='Updated at')),
                ('adeleted_at', models.DateTimeField(editable=False, null=True, verbose_name='Deleted at')),
                ('amr_method', models.CharField(max_length=25, unique=True, verbose_name='AMR Method')),
                ('seq_method', models.CharField(max_length=25, unique=True, verbose_name='Seq Method')),
                ('seq_coverage', models.FloatField(blank=True, default=0, verbose_name='Seq Coverage')),
                ('seq_identity', models.FloatField(blank=True, default=0, verbose_name='Seq Identity')),
                ('closest_id', models.CharField(max_length=25, unique=True, verbose_name='AMR Method')),
                ('closest_name', models.CharField(max_length=25, unique=True, verbose_name='AMR Method')),
                ('acreated', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_acreated_by', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('adeleted', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_adeleted_by', to=settings.AUTH_USER_MODEL, verbose_name='Deleted by')),
                ('aupdated', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_aupdated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by')),
        ...
        migrations.AddIndex(
            model_name='amr_genotype',
            index=models.Index(fields=['orgbatch_id'], name='amrgt_obid_idx'),
        ),
    ]
