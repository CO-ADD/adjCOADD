...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('dorganism', '0017_organism_collect_age_organism_collect_body_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['orgbatch_id'], name='fastqc_orgbid_idx'),
        ),
        migrations.AddIndex(
            model_name='wgs_fastqc',
        ...
        migrations.AddIndex(
            model_name='wgs_fastqc',
            index=models.Index(fields=['run_id'], name='fastqc_runid_idx'),
        ),
        migrations.AddIndex(
            model_name='wgs_checkm',
            index=models.Index(fields=['orgbatch_id'], name='checkqc_orgbid_idx'),
        ),
        migrations.AddIndex(
            model_name='wgs_checkm',
            index=models.Index(fields=['run_id'], name='checkqc_runid_idx'),
        ),
        migrations.AddIndex(
            model_name='id_sequence',
            index=models.Index(fields=['orgbatch_id'], name='idseq_drugid_idx'),
        ),
        migrations.AddIndex(
            model_name='id_sequence',
            index=models.Index(fields=['id_type'], name='idseq_idtype_idx'),
        ),
        migrations.AddIndex(
            model_name='id_sequence',
            index=models.Index(fields=['id_method'], name='idseq_idmed_idx'),
        ),
        migrations.AddIndex(
            model_name='id_sequence',
            index=models.Index(fields=['run_id'], name='idseq_runid_idx'),
        ),
        migrations.AddIndex(
            model_name='id_sequence',
        ...
        migrations.AddIndex(
            model_name='id_pub',
            index=models.Index(fields=['id_organism'], name='idp_org_idx'),
        ),
        migrations.AddIndex(
            model_name='id_pub',
