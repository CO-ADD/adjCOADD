    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gene_id', models.CharField(max_length=15, primary_key=True, serialize=False, verbose_name='Gene ID')),
                ('gene_code', models.CharField(max_length=25, unique=True, verbose_name='Gene Code')),
                ('gene_name', models.CharField(blank=True, max_length=25, verbose_name='Gene Name')),
                ...
                ('gene_subtype', models.CharField(blank=True, max_length=50, verbose_name='Gene Subtype')),
                ('amr_class', models.CharField(blank=True, max_length=50, verbose_name='AMR Class')),
                ('amr_subclass', models.CharField(blank=True, max_length=250, verbose_name='AMR Subclass')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seq_files', models.CharField(blank=True, max_length=150, verbose_name='Files')),
                ('acreated', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_acreated_by', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('adeleted', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_adeleted_by', to=settings.AUTH_USER_MODEL, verbose_name='Deleted by')),
                ('aupdated', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_aupdated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aupdated_at', models.DateTimeField(editable=False, null=True, verbose_name='Updated at')),
                ('adeleted_at', models.DateTimeField(editable=False, null=True, verbose_name='Deleted at')),
                ('amr_method', models.CharField(blank=True, max_length=25, verbose_name='AMR Method')),
                ('seq_method', models.CharField(blank=True, max_length=25, verbose_name='Seq Method')),
                ('seq_coverage', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=9, verbose_name='Seq Coverage')),
                ('seq_identity', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=9, verbose_name='Seq Identity')),
                ('closest_id', models.CharField(blank=True, max_length=150, verbose_name='Closest')),
                ('closest_name', models.CharField(blank=True, max_length=150, verbose_name='Closest Name')),
                ('acreated', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_acreated_by', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('adeleted', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_adeleted_by', to=settings.AUTH_USER_MODEL, verbose_name='Deleted by')),
                ('aupdated', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_aupdated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by')),
                ('gene_id', models.ForeignKey(db_column='gene_id', on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_geneid', to='dgene.gene', verbose_name='Gene ID')),
                ('seq_id', models.ForeignKey(blank=True, db_column='seq_id', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_seqid', to='dgene.genome_sequence', verbose_name='Seq ID')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seq_id', models.ForeignKey(db_column='seq_id', on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_seqid', to='dgene.genome_sequence', verbose_name='Seq ID')),
            ],
            options={
                'db_table': 'id_seq',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fasta', models.CharField(blank=True, max_length=55, verbose_name='Fasta')),
                ...
                ('coding_density', models.DecimalField(blank=True, decimal_places=3, default=0, max_digits=9, verbose_name='coding_density')),
                ('completeness', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=9, verbose_name='completeness')),
                ('contamination', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=9, verbose_name='contamination')),
                ('gc', models.DecimalField(blank=True, decimal_places=3, default=0, max_digits=9, verbose_name='gc')),
                ('gc_std', models.DecimalField(blank=True, decimal_places=3, default=0, max_digits=9, verbose_name='gc_std')),
                ...
                ('mean_contigs', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=12, verbose_name='mean_contigs')),
        ...
        migrations.AddIndex(
            model_name='gene',
            index=models.Index(fields=['amr_class'], name='gene_aclass_idx'),
        ),
        migrations.AddIndex(
            model_name='gene',
            index=models.Index(fields=['amr_subclass'], name='gene_asclass_idx'),
        ),
        migrations.AddIndex(
            model_name='gene',
        ...
        migrations.AddIndex(
            model_name='gene',
            index=models.Index(fields=['source'], name='gene_src_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['amr_method'], name='amrgt_am_idx'),
        ),
        migrations.AddIndex(
            model_name='amr_genotype',
            index=models.Index(fields=['gene_id'], name='amrgt_gid_idx'),
        ),
        migrations.AddIndex(
            model_name='amr_genotype',
            index=models.Index(fields=['seq_id'], name='amrgt_sid_idx'),
        ),
        migrations.AddIndex(
            model_name='id_pub',
        ...
        migrations.AddIndex(
            model_name='id_pub',
            index=models.Index(fields=['id_type'], name='idp_idtype_idx'),
        ),
        migrations.AddIndex(
            model_name='id_pub',
            index=models.Index(fields=['source'], name='idp_source_idx'),
        ),
        migrations.AddIndex(
            model_name='id_sequence',
            index=models.Index(fields=['seq_file'], name='idseq_seqfile_idx'),
        ),
        migrations.AddIndex(
            model_name='id_sequence',
        ...
        migrations.AddIndex(
            model_name='id_sequence',
            index=models.Index(fields=['source'], name='idseq_source_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='wgs_checkm',
            index=models.Index(fields=['assembly'], name='checkqc_ass_idx'),
        ),
        migrations.AddIndex(
            model_name='wgs_checkm',
            index=models.Index(fields=['fasta'], name='checkqc_fa_idx'),
        ),
        migrations.AddIndex(
            model_name='wgs_checkm',
            index=models.Index(fields=['completeness'], name='checkqc_comp_idx'),
        ),
        migrations.AddIndex(
            model_name='wgs_checkm',
            index=models.Index(fields=['contamination'], name='checkqc_cont_idx'),
        ),
        migrations.AddIndex(
            model_name='wgs_checkm',
            index=models.Index(fields=['assembly_qc'], name='checkqc_qc_idx'),
        ),
        migrations.AddIndex(
            model_name='wgs_checkm',
            index=models.Index(fields=['marker_lineage'], name='checkqc_ml_idx'),
        ),
        migrations.AddIndex(
            model_name='wgs_fastqc',
            index=models.Index(fields=['seq'], name='fastqc_seq_idx'),
        ),
        migrations.AddIndex(
            model_name='wgs_fastqc',
