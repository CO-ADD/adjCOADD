...
#=================================================================================================
    ...
    gene_name = models.CharField(max_length=100, blank=True,  verbose_name = "Gene Name")
    ...
    amr_class = models.CharField(max_length=250, blank=True,  verbose_name = "AMR Class")
    amr_subclass = models.CharField(max_length=250, blank=True,  verbose_name = "AMR Subclass")
    gene_modification = models.CharField(max_length=250, verbose_name = "Modification")
    protein_name = models.CharField(max_length=250, blank=True,  verbose_name = "Protein")
    protein_class = models.CharField(max_length=250, blank=True,  verbose_name = "Class")
    protein_subclass = models.CharField(max_length=250,  blank=True, verbose_name = "SubClass")
    resistance_class = models.CharField(max_length=250, blank=True,  verbose_name = "Resistance Class")
    variants = models.CharField(max_length=250, blank=True,  verbose_name = "Variants")
    genbank = models.CharField(max_length=150, blank=True,  verbose_name = "GenBank")
    uniprot = models.CharField(max_length=150, blank=True,  verbose_name = "UniProt")
    organisms =ArrayField(models.CharField(max_length=120, null=True, blank=True), size=10, verbose_name = "Organisms", null=True, blank=True)
