...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apputil.context_processors.global_settings'
            ],
        },
    },
]
...
DATABASES = {
    ...
    'dscreen': {
        "ENGINE": PG_ENGINE,
        'OPTIONS':{'options': '-c search_path=dscreen,dsample,dchem,dorganism,dcell,dplate,apputil,public', 
                   'isolation_level': psycopg2.extensions.ISOLATION_LEVEL_SERIALIZABLE,},
        'NAME': DB_NAME,'USER': DB_USER, 'PASSWORD':DB_PASSWD,
        'HOST': HOST_NAME, 'PORT': '5432',
    },
    ...
    'dsummary': {
        "ENGINE": PG_ENGINE,
        'OPTIONS':{'options': '-c search_path=dsummary,dplate,dscreen,dsample,dchem,apputil,public', 
                   'isolation_level': psycopg2.extensions.ISOLATION_LEVEL_SERIALIZABLE,},
        'NAME': DB_NAME,'USER': DB_USER, 'PASSWORD':DB_PASSWD,
        'HOST': HOST_NAME, 'PORT': '5432',
    }
