...
DATABASES = {
    ...
    'dchem': {
        "ENGINE": PG_ENGINE,
        'OPTIONS':{'options': '-c search_path=dchem,apputil,public', 'isolation_level': psycopg2.extensions.ISOLATION_LEVEL_SERIALIZABLE,},
        'NAME': DB_NAME,'USER': DB_USER, 'PASSWORD':DB_PASSWD,
        'HOST': HOST_NAME, 'PORT': '5432',
    },
    'dsample': {
        "ENGINE": PG_ENGINE,
        'OPTIONS':{'options': '-c search_path=dsample,dchem,dcollab,apputil,public', 'isolation_level': psycopg2.extensions.ISOLATION_LEVEL_SERIALIZABLE,},
        'NAME': DB_NAME,'USER': DB_USER, 'PASSWORD':DB_PASSWD,
        'HOST': HOST_NAME, 'PORT': '5432',
    },
    'dplate': {
