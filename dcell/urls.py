...
from dcell.views import  (Cell_ListView,Cell_CardView,Cell_CreateView, Cell_DetailView, Cell_UpdateView, Cell_RemoveView,
                     CellBatch_ListView, CellBatch_CreateView, CellBatch_RemoveView, CellBatch_UpdateView, 
...
urlpatterns = [
    ...
    path('deleteCell/<str:pk>', Cell_RemoveView.as_view(), name="cell_delete"),
    ...
    path('deleteBat/<str:pk>', CellBatch_RemoveView.as_view(), name="cell_batch_delete"),
    ...
    path('deleteStock/<str:pk>/', CellBatchStock_RemoveView.as_view(), name="cell_stock_delete"),
