    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('previous_batch_id', models.CharField(blank=True, max_length=20, verbose_name='Previous CellBatch ID')),
                ('passage_number', models.CharField(blank=True, max_length=20, verbose_name='Passage Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aupdated', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_aupdated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by')),
                ('biologist', models.ForeignKey(blank=True, db_column='biologist', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_biologist', to=settings.AUTH_USER_MODEL, verbose_name='Biologist')),
                ('cell_id', models.ForeignKey(db_column='organism_id', on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_organism_id', to='dcell.cell', verbose_name='Organism ID')),
        ...
        migrations.AddIndex(
            model_name='cell_culture',
            index=models.Index(fields=['media'], name='cellcult_media_idx'),
        ),
        migrations.AddIndex(
            model_name='cell_culture',
            index=models.Index(fields=['culture_type'], name='cellcult_ctype_idx'),
        ),
        migrations.AddIndex(
