...
def main(prgArgs,djDir):
   ...
   # Illumina WGS data from RDM  ---------------------------------------------
    if prgArgs.table == 'Illumina':
        if prgArgs.orgbatchid and prgArgs.runid:
            
            #vLog = Validation_Log('WGS-Upload')
...
if __name__ == "__main__":
   ...
   # ArgParser -------------------------------------------------------------
    prgParser = configargparse.ArgumentParser(prog='upload_Django_Data', 
                                description="Uploading WGS data from RDM")
    prgParser.add_argument("-t",default=None,required=True, dest="table", action='store', help="Table to upload [Illumina]")
