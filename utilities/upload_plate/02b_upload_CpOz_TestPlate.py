...
def main(prgArgs,djDir):
    ...
    from applib.plate.testplates import read_cpoz_edr
   ...
   # TestPlate XLSX -------------------------------------------------------------
    if prgArgs.edrname:
        TP_Dict = read_cpoz_edr(prgArgs.edrname,prgArgs.skipname)
        
        if prgArgs.upload:
            for p in tqdm(TP_Dict,desc=" CpOz Saving"):
                TP_Dict[p].save()
...
if __name__ == "__main__":
    ...
    #prgParser.add_argument("-t",default=None,required=True, dest="table", action='store', help="Table to upload [TestPlateDoseresponse]")
...
#    prgParser.add_argument("-d","--directory",default=None,required=False, dest="directory", action='store', help="Directory or Folder to parse")
    prgParser.add_argument("-e","--edr",default=None,required=False, dest="edrname", action='store', help="EDR File Name")
    prgParser.add_argument("-s","--skip",default=None,required=False, dest="skipname", action='store', help="Skips File Name")
