    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Dict_Value', app.models.ChoiceArrayField(base_field=models.CharField(choices=[('defect', 'Defect'), ('enhancement', 'Enhancement')], max_length=510), default=list, size=None)),
