    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Dictionary_ID', models.CharField(db_index=True, max_length=30, verbose_name='Dictionary')),
                ('Dictionary_Class', models.CharField(max_length=30, verbose_name='Dictionary_Class')),
                ('Dict_Value', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=150, null=True), blank=True, default=list, size=None)),
                ...
                ('Dict_View_Order', models.IntegerField(null=True, verbose_name='View Order')),
