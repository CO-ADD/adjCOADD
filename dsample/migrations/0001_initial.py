    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['compound_id'],
                'indexes': [models.Index(fields=['compound_name'], name='abcmp_name_idx'), models.Index(fields=['compound_code'], name='abcmp_code_idx'), models.Index(fields=['structure_id'], name='abcmp_sid_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adeleted', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_adeleted_by', to=settings.AUTH_USER_MODEL, verbose_name='Deleted by')),
                ('aupdated', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_aupdated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by')),
                ('chemist', models.ForeignKey(blank=True, db_column='chemist', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_chemist', to=settings.AUTH_USER_MODEL, verbose_name='Chemist')),
                ('compound_id', models.ForeignKey(blank=True, db_column='compound_id', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_compound_id', to='dsample.abase_compound', verbose_name='Compound ID')),
                ('init_amount_unit', models.ForeignKey(blank=True, db_column='init_amount_unit', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_init_amount_unit', to='apputil.dictionary', verbose_name='Init Amount Unit')),
                ('project_id', models.ForeignKey(blank=True, db_column='project_id', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_project_id', to='dsample.project', verbose_name='Project ID')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['role'], name='pmem_role_idx'),
        ),
        migrations.AddIndex(
